...
export const LeadershipSection = () => (
  <section className="py-12 sm:py-16 md:py-24 bg-white border-t border-slate-100 w-full overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4 text-slate-500">
            ...
            <span className="uppercase tracking-widest font-bold text-xs sm:text-sm">Diplomacia Técnica</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-4 sm:mb-6 px-2">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          variants={fadeInUp}
          className="relative my-8 sm:my-12 md:my-16 p-6 sm:p-8 md:p-10 bg-slate-50 border-l-4 border-amber-600 rounded-r-lg"
        >
          <div className="absolute top-3 sm:top-4 left-3 sm:left-4 text-slate-200">
            <svg width="40" height="40" className="sm:w-[60px] sm:h-[60px]" viewBox="0 0 24 24" fill="currentColor">
          ...
          <blockquote className="text-lg sm:text-xl md:text-2xl font-serif text-slate-800 text-center relative z-10 italic px-2">
            "Quem estudou isso na faculdade é quem deve assinar."
          </blockquote>
          <p className="text-center text-xs sm:text-sm text-slate-500 mt-3 sm:mt-4 font-bold uppercase tracking-wide px-2">— Celso Ternes Leal, sobre responsabilidade técnica</p>
        </motion.div>
        ...
        <div className="mt-8 sm:mt-12 bg-slate-100 p-4 sm:p-6 rounded-lg text-center">
          <h4 className="font-bold text-slate-900 mb-2 text-sm sm:text-base">O Estilo "Leal" de Liderança</h4>
